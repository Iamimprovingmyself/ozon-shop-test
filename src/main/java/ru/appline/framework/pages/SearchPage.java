...
public class SearchPage extends BasePage {
    ...
    @Step("Ограниче цены продукта {upLimit}")
    public SearchPage clickProductSearch(Integer upLimit) {
        ...
        Assertions.assertEquals("" + upLimit, searchUpLimitElement.getAttribute("value"), "Ограничение цены " + upLimit + " в графе 'до' заполнено некорректно");
        return application.getPage(SearchPage.class);
    }

    @Step("Заполнение фильтров {nameField}, {value}")
    ...
    @Step("Добавление в корзину первых {countProduct} четных продуктов")
    ...
    @Step("Добавление всех нечетных продуктов на странице в корзину")
